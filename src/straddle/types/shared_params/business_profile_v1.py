...
from ..embed.address_v1_param import AddressV1Param
from ..embed.industry_v1_param import IndustryV1Param
from ..embed.support_channels_v1_param import SupportChannelsV1Param

__all__ = ["BusinessProfileV1"]


class BusinessProfileV1(TypedDict, total=False):
    name: Required[str]
