...
from .paged_response_metadata import PagedResponseMetadata

__all__ = ["PagedResponseOfCapabilityRequestV1", "Data"]
...
class PagedResponseOfCapabilityRequestV1(BaseModel):
    data: List[Data]
