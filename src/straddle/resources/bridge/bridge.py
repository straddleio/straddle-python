...
from ...types import bridge_plaid_params, bridge_initialize_params
...
from .bank_account import (
    BankAccountResource,
    AsyncBankAccountResource,
    BankAccountResourceWithRawResponse,
    AsyncBankAccountResourceWithRawResponse,
    BankAccountResourceWithStreamingResponse,
...
class BridgeResource(SyncAPIResource):
    @cached_property
    def bank_account(self) -> BankAccountResource:
        return BankAccountResource(self._client)
...
class AsyncBridgeResource(AsyncAPIResource):
    @cached_property
    def bank_account(self) -> AsyncBankAccountResource:
        return AsyncBankAccountResource(self._client)
...
class BridgeResourceWithRawResponse:
    ...
    @cached_property
    def bank_account(self) -> BankAccountResourceWithRawResponse:
        return BankAccountResourceWithRawResponse(self._bridge.bank_account)
...
class AsyncBridgeResourceWithRawResponse:
    ...
    @cached_property
    def bank_account(self) -> AsyncBankAccountResourceWithRawResponse:
        return AsyncBankAccountResourceWithRawResponse(self._bridge.bank_account)
...
class BridgeResourceWithStreamingResponse:
    ...
    @cached_property
    def bank_account(self) -> BankAccountResourceWithStreamingResponse:
        return BankAccountResourceWithStreamingResponse(self._bridge.bank_account)
...
class AsyncBridgeResourceWithStreamingResponse:
    ...
    @cached_property
    def bank_account(self) -> AsyncBankAccountResourceWithStreamingResponse:
        return AsyncBankAccountResourceWithStreamingResponse(self._bridge.bank_account)
