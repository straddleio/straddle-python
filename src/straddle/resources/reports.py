...
from ..types.report_total_customers_by_status_response import ReportTotalCustomersByStatusResponse
    ...
    def total_customers_by_status(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=ReportTotalCustomersByStatusResponse,
        )
...
class AsyncReportsResource(AsyncAPIResource):
    ...
    async def total_customers_by_status(
        self,
        *,
        correlation_id: str | NotGiven = NOT_GIVEN,
        request_id: str | NotGiven = NOT_GIVEN,
...
class ReportsResourceWithRawResponse:
    def __init__(self, reports: ReportsResource) -> None:
        ...
        self.total_customers_by_status = to_raw_response_wrapper(
            reports.total_customers_by_status,
        )
...
class AsyncReportsResourceWithRawResponse:
    def __init__(self, reports: AsyncReportsResource) -> None:
        ...
        self.total_customers_by_status = async_to_raw_response_wrapper(
            reports.total_customers_by_status,
        )
...
class ReportsResourceWithStreamingResponse:
    def __init__(self, reports: ReportsResource) -> None:
        ...
        self.total_customers_by_status = to_streamed_response_wrapper(
            reports.total_customers_by_status,
        )
...
class AsyncReportsResourceWithStreamingResponse:
    def __init__(self, reports: AsyncReportsResource) -> None:
        ...
        self.total_customers_by_status = async_to_streamed_response_wrapper(
            reports.total_customers_by_status,
        )
