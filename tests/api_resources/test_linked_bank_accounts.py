...
from straddle.types.linked_bank_account_paged import Data
...
class TestLinkedBankAccounts:
    ...
    def test_method_get(self, client: Straddle) -> None:
        linked_bank_account = client.linked_bank_accounts.get(
            linked_bank_account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(LinkedBankAccount, linked_bank_account, path=["response"])
    ...
    def test_raw_response_get(self, client: Straddle) -> None:
        response = client.linked_bank_accounts.with_raw_response.get(
            linked_bank_account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: Straddle) -> None:
        with client.linked_bank_accounts.with_streaming_response.get(
            linked_bank_account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Straddle) -> None:
        with pytest.raises(
            ...
            client.linked_bank_accounts.with_raw_response.get(
                linked_bank_account_id="",
            )
...
class TestAsyncLinkedBankAccounts:
    ...
    async def test_method_get(self, async_client: AsyncStraddle) -> None:
        linked_bank_account = await async_client.linked_bank_accounts.get(
            linked_bank_account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(LinkedBankAccount, linked_bank_account, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncStraddle) -> None:
        response = await async_client.linked_bank_accounts.with_raw_response.get(
            linked_bank_account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncStraddle) -> None:
        async with async_client.linked_bank_accounts.with_streaming_response.get(
            linked_bank_account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncStraddle) -> None:
        with pytest.raises(
            ...
            await async_client.linked_bank_accounts.with_raw_response.get(
                linked_bank_account_id="",
            )
