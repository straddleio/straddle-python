...
class TestCapabilityRequests:
    ...
    def test_method_create(self, client: Straddle) -> None:
        capability_request = client.accounts.capability_requests.create(
    ...
    def test_raw_response_create(self, client: Straddle) -> None:
        response = client.accounts.capability_requests.with_raw_response.create(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create(self, client: Straddle) -> None:
        with client.accounts.capability_requests.with_streaming_response.create(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_create(self, client: Straddle) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.accounts.capability_requests.with_raw_response.create(
                account_id="",
            )
    ...
    def test_raw_response_list(self, client: Straddle) -> None:
        response = client.accounts.capability_requests.with_raw_response.list(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: Straddle) -> None:
        with client.accounts.capability_requests.with_streaming_response.list(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Straddle) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.accounts.capability_requests.with_raw_response.list(
                account_id="",
            )
...
class TestAsyncCapabilityRequests:
    ...
    async def test_method_create(self, async_client: AsyncStraddle) -> None:
        capability_request = await async_client.accounts.capability_requests.create(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(CapabilityRequestPaged, capability_request, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncStraddle) -> None:
        response = await async_client.accounts.capability_requests.with_raw_response.create(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncStraddle) -> None:
        async with async_client.accounts.capability_requests.with_streaming_response.create(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncStraddle) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.accounts.capability_requests.with_raw_response.create(
                account_id="",
            )
    ...
    async def test_raw_response_list(self, async_client: AsyncStraddle) -> None:
        response = await async_client.accounts.capability_requests.with_raw_response.list(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncStraddle) -> None:
        async with async_client.accounts.capability_requests.with_streaming_response.list(
            account_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncStraddle) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.accounts.capability_requests.with_raw_response.list(
                account_id="",
            )
