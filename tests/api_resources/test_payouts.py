...
class TestPayouts:
    ...
    @parametrize
    def test_method_upload_authorization_document(self, client: Straddle) -> None:
        payout = client.payouts.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
        )
        assert_matches_type(PayoutV1, payout, path=["response"])
    ...
    @parametrize
    def test_method_upload_authorization_document_with_all_params(self, client: Straddle) -> None:
        payout = client.payouts.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
            correlation_id="Correlation-Id",
    ...
    @parametrize
    def test_raw_response_upload_authorization_document(self, client: Straddle) -> None:
        response = client.payouts.with_raw_response.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
        )
    ...
    @parametrize
    def test_streaming_response_upload_authorization_document(self, client: Straddle) -> None:
        with client.payouts.with_streaming_response.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
        ) as response:
            assert not response.is_closed
    ...
    @parametrize
    def test_path_params_upload_authorization_document(self, client: Straddle) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.payouts.with_raw_response.upload_authorization_document(
                id="",
                file=b"Example data",
            )
...
class TestAsyncPayouts:
    ...
    @parametrize
    async def test_method_upload_authorization_document(self, async_client: AsyncStraddle) -> None:
        payout = await async_client.payouts.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
        )
        assert_matches_type(PayoutV1, payout, path=["response"])
    ...
    @parametrize
    async def test_method_upload_authorization_document_with_all_params(self, async_client: AsyncStraddle) -> None:
        payout = await async_client.payouts.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
            correlation_id="Correlation-Id",
    ...
    @parametrize
    async def test_raw_response_upload_authorization_document(self, async_client: AsyncStraddle) -> None:
        response = await async_client.payouts.with_raw_response.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
        )
    ...
    @parametrize
    async def test_streaming_response_upload_authorization_document(self, async_client: AsyncStraddle) -> None:
        async with async_client.payouts.with_streaming_response.upload_authorization_document(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            file=b"Example data",
        ) as response:
            assert not response.is_closed
    ...
    @parametrize
    async def test_path_params_upload_authorization_document(self, async_client: AsyncStraddle) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.payouts.with_raw_response.upload_authorization_document(
                id="",
                file=b"Example data",
            )
