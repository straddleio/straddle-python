...
from straddle.types.shared import OrganizationV1, ItemResponseOfOrganizationV1
...
class TestOrganizations:
    ...
    def test_method_create(self, client: Straddle) -> None:
        ...
        assert_matches_type(ItemResponseOfOrganizationV1, organization, path=["response"])
    ...
    def test_method_list(self, client: Straddle) -> None:
        ...
        assert_matches_type(SyncPageNumberSchema[OrganizationV1], organization, path=["response"])
...
class TestAsyncOrganizations:
    ...
    async def test_method_list(self, async_client: AsyncStraddle) -> None:
        ...
        assert_matches_type(AsyncPageNumberSchema[OrganizationV1], organization, path=["response"])
