...
from straddle.types.shared import FundingEventSummaryV1
...
class TestFundingEvents:
    ...
    def test_method_list(self, client: Straddle) -> None:
        ...
        assert_matches_type(SyncPageNumberSchema[FundingEventSummaryV1], funding_event, path=["response"])
...
class TestAsyncFundingEvents:
    ...
    async def test_method_list(self, async_client: AsyncStraddle) -> None:
        ...
        assert_matches_type(AsyncPageNumberSchema[FundingEventSummaryV1], funding_event, path=["response"])
